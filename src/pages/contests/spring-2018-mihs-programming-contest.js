...
import AdvancedScoreboardDoc from "@docs/spring_2018_mihs/advanced_scoreboard.pdf"
import IntermediateScoreboardDoc from "@docs/spring_2018_mihs/intermediate_scoreboard.pdf"
import ProblemPacketDoc from "@docs/spring_2018_mihs/problem_set.pdf"
import JudgesAnswerDoc from "@docs/spring_2018_mihs/inputs_outputs.zip"
import InputsDoc from "@docs/spring_2018_mihs/judges_data.pdf"
  ...
  <img class="about-landing-image"src={DarkIMG} />
    <div class="introduction">
      <h1 class="ui inverted header">
        <span class="library">
        Spring 2018 MIHS Programming Contest
        </span>
        <br/>
      </h1>
...
<div class="ui vertical stripe intro segment">
  ...
  <div class="two column ui grid container">
    <div class="row">
      ...
      <p>1st - Bear Creek Team [Bear Creek School]</p>
      <p>2nd - Independent Justin Chen Academy [Iinterlake High School]</p>
      <p>3rd - Delete System32 [Newport High School]</p>
      <h3>Advanced Division</h3>
      <p>1st - Loop Invariants [Newport High School]</p>
      <p>2nd - Grammar Matters [Newport High School]</p>
      <p>3rd - Dorper [Mercer Island High School]</p>
      
      </div>
      <div class="column">
      <h2>Gold Sponsors</h2>
      <Image size="small" src={JetBrainsIMG} /><br />
      <Image size="small" src={PagliacciIMG} /><br />
      <h2>Silver Sponsor</h2>
      <Image size="small" src={PSCSTAIMG} /><br />
      <h2>Bronze Sponsors</h2>
      <Image size="small" src={TwilioIMG} /><br />
      <Image size="small" src={TopcoderIMG} /><br />
      </div>
    </div>
  </div>
  <div class="ui container">
      ...
      <h2>Sponsors</h2>
      <Image size="small" src={JetBrainsIMG} />
      <Image size="medium" src={TopcoderIMG} /><br />
      <Image size="medium" src={TwilioIMG} />
