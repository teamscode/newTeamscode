...
import AdvancedScoreboardDoc from "@docs/fall_2018_mihs/advanced_scoreboard.pdf"
import IntermediateScoreboardDoc from "@docs/fall_2018_mihs/intermediate_scoreboard.pdf"
import ProblemPacketDoc from "@docs/fall_2018_mihs/problem_set.pdf"
import JudgesAnswerDoc from "@docs/fall_2018_mihs/inputs_outputs.zip"
import InputsDoc from "@docs/fall_2018_mihs/judges_data.pdf"
...
<div class="ui vertical stripe intro segment">
  ...
  <div class="two column ui grid container">
    <div class="row">
      ...
      <p>1st - DenverCoding9 [Newport High School + Bellevue High School]</p>
      <p>2nd - aae [Newport High School]</p>
      <p>3rd - Idolers [Interlake High School + Odle Middle School]</p>
      <h3>Advanced Division</h3>
      <p>1st - The Invincibles [Newport High School]</p>
      <p>2nd - What's Java? [Newport High School + Interlake High School]</p>
      <p>3rd - Ip0 on fire [Garfield High School]</p>
      ...
      <Image size="small" src={CrelateIMG} /><br />
      </div>
    </div>
  </div>
  <div class="ui container">
      ...
      <a href="https://drive.google.com/drive/folders/1x10udM3sz2gzyxpOGPKdb2sDSlmMgzaw">Photo Album</a><br />
      

      <h2>Sponsors</h2>
      <p><b>Platinum Sponsor:</b><a href="http://www.smartcodingschool.com/"> Smart Coding School</a></p><br />
      <Image size="medium" src={SmartCodingSchoolIMG} /><br />
      <p><b>Gold Sponsor:</b><a href="http://www.audian.com/"> Audian</a></p><br />
      <Image size="medium" src={AudianIMG} /><br />
      <p><b>Silver Sponsor:</b><a href="https://pagliacci.com/"> Pagliacci</a></p><br />
      <Image size="medium" src={PagliacciIMG} /><br />
      <p><b>Bronze Sponsor:</b><a href="https://www.crelate.com/"> Crelate</a></p><br />
      <Image size="medium" src={CrelateIMG} /><br />
