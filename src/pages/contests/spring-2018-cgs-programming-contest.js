...
import ScoreboardDoc from "@docs/spring_2018_cgs/scoreboard.pdf"
import ProblemPacketDoc from "@docs/spring_2018_cgs/problem_set.pdf"
import JudgesAnswerDoc from "@docs/spring_2018_cgs/inputs_outputs.zip"
import InputsDoc from "@docs/spring_2018_cgs/judges_data.pdf"
  ...
  <img class="about-landing-image"src={DarkIMG} />
    <div class="introduction">
      <h1 class="ui inverted header">
        <span class="library">
        Spring 2018 CGS Programming Contest
        </span>
        <br/>
      </h1>
...
<div class="ui vertical stripe intro segment">
  ...
  <div class="two column ui grid container">
    <div class="row">
      ...
      <p>1st - Peace, Land, and Bread [Wilson High School]</p>
      <h3>Advanced Division</h3>
      <p>1st - AC [Westview High School]</p>
      <p>2nd - Waherl [Tech4Kids Club]</p>
      <p>3rd - Panda Ramen [Sunset High School]</p>
      
      </div>
      <div class="column">
      <h2>Gold Sponsor</h2>
      <Image size="small" src={SiliconLabsIMG} /><br />
      </div>
    </div>
  </div>
  <div class="ui container">
      <h1>Contest Files</h1>
      <a href={ScoreboardDoc} download="teamscode">Scoreboard</a><br />
      ...
      <a href="https://drive.google.com/open?id=117QXcUUzm0AdszmzsFQt1zKQBQrJcdND">Photo Album</a><br />
      

      <h2>Sponsors</h2>
      <Image size="medium" src={SiliconLabsIMG} /><br />
